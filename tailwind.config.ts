    ...
    extend: {
      ...
      colors: {
        ...
        cta: {
          ...
          "primary-text": "hsl(var(--cta-primary-text))",
          "secondary-border": "hsl(var(--cta-secondary-border))",
          "secondary-text": "hsl(var(--cta-secondary-text))",
        },
      ...
      transitionTimingFunction: {
        // Easing standard del progetto (ever-style, exp-out). Vedi src/lib/easing.ts → EASE.outExpo
